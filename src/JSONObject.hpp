...
namespace json
{
    ...
    {   
        public:
            ...
            /**
             * Retrieve the float value from the JSON object associated with the key.
             * @param key name of the value.
            ...
            /**
             * Retrieve the byte value from the JSON object associated with the key.
             * @param key name of the value.
             * @return the byte associated with the key.
             */
            int8_t getByte(const std::string& key) const;
            /**
             * Retrieve the short value from the JSON object associated with the key.
             * @param key name of the value.
            ...
            /**
             * Retrieve the uint64_t value from the JSON object associated with the key.
             * @param key name of the value.
             * @return the uint64_t associated with the key.
             */
            ...
            /**
             * Insert a float value with the specified key.
             * @param key name of the value.
             * @param value the value associated with the key.
             */
            ...
            /**
             * Insert a int8_t value with the specified key.
             * @param key name of the value.
             * @param value the value associated with the key.
             */
            void put(const std::string& key, const int8_t value);
            /**
             * Insert a short value with the specified key.
             * @param key name of the value.
             * @param value the value associated with the key.
             */
            void put(const std::string& key, const short value);
            /**
            ...
            /**
             * Insert a uint64_t value with the specified key.
             * @param key name of the value.
             * @param value the value associated with the key.
             */     
            void put(const std::string& key, const int64_t value);
            /**
